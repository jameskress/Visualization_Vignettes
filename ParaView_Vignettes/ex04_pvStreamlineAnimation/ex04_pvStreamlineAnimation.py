...
resampleToImage1 = ResampleToImage(
    registrationName="ResampleToImage1", Input=transform1
)
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice2Display.ScaleTransferFunction.Points = [
    -0.24874216318130493,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice2Display.OpacityTransferFunction.Points = [
    -0.24874216318130493,
    0.0,
    0.5,
    0.0,
...
for ts in range(0, 125):
    ...
    # save screenshot
    SaveScreenshot(
        script_dir + "/output/ex04_%04d.png" % ts,
        renderView1,
