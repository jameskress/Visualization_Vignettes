...
renderView1.CameraFocalPoint = [3.2500000000000044, 3.250000000000006, 3.250000000000006]
renderView1.CameraViewUp = [-0.621575432095255, -0.10749140160884736, -0.7759443155251301]
...
clip1.HyperTreeGridClipper.Origin = [3.250000048428774, 3.250000048428774, 3.250000048428774]
...
uLUT.RGBPoints = [0.1449777870244238, 0.231373, 0.298039, 0.752941, 0.5724891890196234, 0.865003, 0.865003, 0.865003, 1.000000591014823, 0.705882, 0.0156863, 0.14902]
...
gridDisplay.ScaleTransferFunction.Points = [0.1449777870244238, 0.0, 0.5, 0.0, 1.000000591014823, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
gridDisplay.OpacityTransferFunction.Points = [0.1449777870244238, 0.0, 0.5, 0.0, 1.000000591014823, 1.0, 0.5, 0.0]

# init the 'Plane' selected for 'SliceFunction'
gridDisplay.SliceFunction.Origin = [3.250000048428774, 3.250000048428774, 3.250000048428774]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
clip1Display.ScaleTransferFunction.Points = [0.1449777870244238, 0.0, 0.5, 0.0, 1.0000005816863944, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
clip1Display.OpacityTransferFunction.Points = [0.1449777870244238, 0.0, 0.5, 0.0, 1.0000005816863944, 1.0, 0.5, 0.0]
